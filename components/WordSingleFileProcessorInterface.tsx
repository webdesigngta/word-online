...
export function WordSingleFileProcessorInterface({
  ...
  return (
    <div className="fwo-single-processor" data-native-upload-ui="true">
      <style>{`
        .fwo-single-processor{display:grid;gap:17px}.fwo-single-drop{min-height:320px;border:1.5px dashed #d6dde8;border-radius:20px;background:linear-gradient(180deg,#fff 0%,#fbfcfe 100%);display:flex;align-items:center;justify-content:center;text-align:center;padding:38px 24px;transition:border-color .16s ease,background-color .16s ease,box-shadow .16s ease}.fwo-single-drop.is-dragging{border-color:#2563eb;background:#f7faff;box-shadow:0 0 0 4px rgba(37,99,235,.08)}.fwo-single-drop-inner{width:min(560px,100%);display:flex;flex-direction:column;align-items:center;justify-content:center;gap:0}.fwo-single-button,.fwo-single-download{border:0;text-decoration:none;font-weight:800;cursor:pointer;display:inline-flex;align-items:center;justify-content:center}.fwo-single-button{min-width:184px;min-height:52px;padding:0 26px;border-radius:14px;background:#2563eb;color:#fff;font-size:15px;line-height:1;box-shadow:0 7px 18px rgba(37,99,235,.18);transition:background-color .14s ease,box-shadow .14s ease}.fwo-single-button:hover:not(:disabled){background:#1d4ed8;box-shadow:0 9px 22px rgba(37,99,235,.22)}.fwo-single-button:focus-visible{outline:3px solid rgba(37,99,235,.22);outline-offset:3px}.fwo-single-button:disabled{opacity:.88;cursor:wait}.fwo-single-button svg{width:17px;height:17px;margin-right:8px;animation:fwo-spin .8s linear infinite}.fwo-single-drop-hint{display:block!important;position:static!important;width:auto!important;margin:14px 0 0!important;color:#64748b!important;font-size:14px!important;font-weight:500!important;line-height:1.5!important;transform:none!important}.fwo-single-meta{position:static!important;width:min(520px,100%);margin:10px 0 0!important;color:#5f6368;font-size:13px;line-height:1.5;display:flex!important;align-items:center;justify-content:center;gap:7px;flex-wrap:wrap;transform:none!important}.fwo-single-meta strong{color:#202124;max-width:260px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.fwo-single-meta.is-busy{color:#2563eb;font-weight:650}.fwo-single-meta-status{display:inline-flex;align-items:center;gap:7px}.fwo-single-meta-spinner{width:15px;height:15px;animation:fwo-spin .8s linear infinite}.fwo-single-result{display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;border:1px solid #cde3d3;border-radius:14px;padding:14px 16px;background:#f4faf6}.fwo-single-result-main{display:flex;align-items:center;gap:11px;min-width:0}.fwo-single-result-icon{width:40px;height:40px;border-radius:11px;background:#e6f4ea;color:#137333;display:grid;place-items:center}.fwo-single-result-icon svg{width:20px}.fwo-single-result-copy{min-width:0}.fwo-single-result-copy strong{display:block;max-width:520px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.fwo-single-result-copy span{display:block;color:#5f6368;font-size:12px;margin-top:4px}.fwo-single-download{min-height:46px;padding:0 18px;border-radius:11px;background:#137333;color:#fff}.fwo-single-warning{font-size:13px;line-height:1.5;color:#66531b;background:#fffaf0;border:1px solid #f3e3b2;border-radius:10px;padding:10px 12px}@keyframes fwo-spin{to{transform:rotate(360deg)}}@media(max-width:640px){.fwo-single-drop{min-height:290px;padding:30px 16px}.fwo-single-button{min-width:176px;min-height:50px;padding:0 22px}.fwo-single-result-copy strong{max-width:230px}.fwo-single-meta{font-size:12px}}
      `}</style>
      ...
      >
        <div className="fwo-single-drop-inner">
          ...
          >
            {busy ? <RefreshCw aria-hidden="true" /> : null}
