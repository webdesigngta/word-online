  ...
  return (
    <header className="site-header product-site-header">
      <style>{`
        ...
        .product-site-header .site-logo{display:block;width:auto;height:46px;max-width:none}
