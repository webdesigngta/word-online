...
export function SiteHeader() {
  return (
    <header className="site-header product-site-header">
      <style>{`
        .product-site-header{height:72px;display:flex;align-items:center;justify-content:space-between;gap:18px;padding:0 clamp(18px,4vw,60px);background:rgba(255,255,255,.96);border-bottom:1px solid #e3e6ea;position:sticky;top:0;z-index:40;backdrop-filter:blur(16px);font-family:Arial,Helvetica,sans-serif}
        .product-site-header .site-brand{display:flex;align-items:center;text-decoration:none;white-space:nowrap;min-width:max-content;line-height:0}
        .product-site-header .site-logo{display:block;width:auto;height:50px;max-width:none}
        ...
        @media(max-width:640px){.product-site-header{height:66px;padding:0 12px;gap:8px}.product-site-header .site-logo{height:40px}.product-site-header .site-nav{gap:1px}.product-site-header .site-nav a{padding:0 8px;font-size:12px}.product-site-header .site-nav a:nth-child(3),.product-site-header .site-nav a:nth-child(5){display:none}}
        @media(max-width:390px){.product-site-header .site-logo{height:36px}.product-site-header .site-nav a{padding:0 7px}}
      `}</style>
      <Link href="/" className="site-brand" aria-label="DOC321 home">
        <img className="site-logo" src="/doc321-logo.png" width="400" height="108" alt="DOC321" decoding="async" />
      </Link>
