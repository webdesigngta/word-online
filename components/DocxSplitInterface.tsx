...
export function DocxSplitInterface() {
  ...
  return (
    <div className="fwo-split-tool">
      ...
      <div className="fwo-split-picker"><Scissors /><h2>Split a Word document by headings</h2><p>Create separate DOCX files at Heading 1, Heading 2 or Heading 3 boundaries.</p><button className="fwo-split-button secondary" type="button" onClick={() => inputRef.current?.click()}>Choose Files</button></div>
