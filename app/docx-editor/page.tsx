  ...
  return (
    <>
      ...
      <WordEditorInfo
        ...
        description="This interface is DOCX-first: open an existing .docx file, edit its readable document content, and export a new DOCX copy without being redirected to a generic editor landing page."
        details={[
        ...
        faq={faq}
      />
      <IntentClusterLinks current="/docx-editor" />
      <SiteFooter />
      <SoftwareJsonLd />
    </>
  );
