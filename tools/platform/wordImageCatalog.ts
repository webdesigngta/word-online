...
export const liveWordImageTools: readonly PlatformToolDefinition[] = [
  {
    ...
    eyebrow: 'WORD TO JPG', primaryIntent: 'Convert Word to JPG', kind: 'word', cluster: 'Word', priority: 'P1', stage: 'Next',
  ...
  },
  {
    ...
    eyebrow: 'WORD TO PNG', primaryIntent: 'Convert Word to PNG', kind: 'word', cluster: 'Word', priority: 'P2', stage: 'Next',
