...
const checks = [
  ...
  [loader.includes('onDropCapture={onDropCapture}'), 'drag-and-drop validation runs before workspace handling'],
  [loader.includes('input.value = \'\';'), 'rejected picker selections are cleared'],
